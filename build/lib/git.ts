...
export function getVersion(repo: string): string | undefined {
	// Start of [ZP-0CA2] build: try to read commit version from vscodium build version file
	...
	// End of [ZP-0CA2] build: try to read commit version from vscodium build version file
